...
{
    public class TachHopsController : Controller
    {
        ...
        {
            return View(db.TachHops.ToList());
        }

        // GET: TachHops/Details/5
        public ActionResult Details(long? id)
        {
            ...
            TachHop tachHop = db.TachHops.Find(id);
            if (tachHop == null)
            {
                return HttpNotFound();
            }
        ...
        {
            TachHop tachThua = db.TachHops.Find(id);
            XTachHop xtd = new XTachHop();
            xtd.obj = tachThua;
        ...
        [HttpPost]
        public ActionResult CreateX(TachHop tachThua, int? id, string b_ngaycap, string d_ngaycap_gt, string d_ngaycap_gt1)
        {
            string result = string.Empty;
            if (!id.HasValue)
            {
                db.TachHops.Add(tachThua);
            }
            else
            {
        ...
        // POST: TachHops/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,infomation_id,type,a_loaigiayto,a_sogiayto,a_hoten,a_ngaysinh,a_gioitinh,a_quoctich,a_nguyenquan,a_hktt,a_thon,a_xa,a_huyen,a_tinh,a_ngaycap_gt,a_noicap_gt,a_masothue,a_loaigiayto1,a_sogiayto1,a_hoten1,a_ngaysinh1,a_gioitinh1,a_quoctich1,a_nguyenquan1,a_hktt1,a_ngaycap_gt1,a_noicap_gt1,b_csh,b_hoten,b_ngaysinh,b_loaigiayto,b_sogiayto,b_diachithuongtru,b_sogiaychungnhan,b_sothua,b_tobando,b_thon,b_xa,b_huyen,b_tinh,b_diachithuadat,b_dientich,b_hinhthucsudung,b_mucdichsudung,b_nguongoc,b_ghichu,b_ngaycap,b_noicap,b_sovaoso,b_loaidat1,b_dientich1,b_loaidat2,b_dientich2,b_loainguongoc,b_chuyenquyen,c_xaphuong,c_xa,c_baocao_veviec,c_dondenghi_noidung,d_sogiayto,d_hoten,d_ngaysinh,d_gioitinh,d_quoctich,d_nguyenquan,d_hktt,d_loaigiayto,d_ngaycap_gt,d_noicap_gt,d_masothue,d_sogiayto1,d_loaigiayto1,d_hoten1,d_ngaysinh1,d_gioitinh1,d_hktt1,d_ngaycap_gt1,d_noicap_gt1,d_loaibiendong,d_noidungbiendong,d_lydobiendong,d_sohopdong,d_noicongchung,d_ngaycongchung,d_tienhopdong,d_vitrithuadat,d_thon,d_xa,d_huyen,d_tinh,e_sogiayto,e_hoten,e_ngaysinh,e_gioitinh,e_quoctich,e_nguyenquan,e_hktt,e_ngaycap_gt,e_noicap_gt,e_masothue,e_giayuyquyenso,e_ngayuyquyen,e_doituong")] TachHop tachHop)
        {
            if (ModelState.IsValid)
            {
                db.Entry(tachHop).State = EntityState.Modified;
                db.SaveChanges();
                return RedirectToAction("Index");
            }
            return View(tachHop);
        ...
        // POST: TachHops/Delete/5
        [HttpPost, ActionName("Delete")]
        [ValidateAntiForgeryToken]
        public ActionResult DeleteConfirmed(long id)
        {
            TachHop tachHop = db.TachHops.Find(id);
            db.TachHops.Remove(tachHop);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
